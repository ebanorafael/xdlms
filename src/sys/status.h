...
typedef enum status_t {
  ...
  STATUS_HDLC_INVALID_FRAME_DELIMITER = STATUS(STATUS_CLASS_HDLC, 3),
  STATUS_HDLC_INVALID_FRAME_FORMAT = STATUS(STATUS_CLASS_HDLC, 4),
  STATUS_HDLC_INVALID_FRAME_LENGTH = STATUS(STATUS_CLASS_HDLC, 5),
